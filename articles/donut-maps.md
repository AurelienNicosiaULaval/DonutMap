...
and flows are simulated for demonstration.
...
scales, labels, and themes can be added afterwards.
...
returns a `leaflet` htmlwidget. Donut segments and flow lines can be
clicked to open popups, and hover labels are enabled by default.
