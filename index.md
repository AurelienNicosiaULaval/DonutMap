...
[![CRAN
status](https://www.r-pkg.org/badges/version/DonutMap)](https://CRAN.R-project.org/package=DonutMap)
...
[`mtennekes/donutmaps`](https://github.com/mtennekes/donutmaps), but
starts from a simpler tidy-data interface and avoids the older
`odf`/`tmap` workflow.

## Online examples

The pkgdown site includes a [getting-started
article](https://aureliennicosiaulaval.github.io/DonutMap/articles/donut-maps.html)
...
computes straight or curved origin-destination `sf` line geometries.
...
Use `flow_curvature = 0` for straight links, positive values for one
bend direction, and negative values for the opposite direction.
...
See
[`vignette("donut-maps", package = "DonutMap")`](https://aureliennicosiaulaval.github.io/DonutMap/articles/donut-maps.md)
